...
import com.example.android.databinding.basicsample.databinding.PlainOldActivityBinding
...
class PlainOldActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val binding: PlainOldActivityBinding =
                DataBindingUtil.setContentView(this, R.layout.plain_old_activity)
